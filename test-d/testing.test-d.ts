...
expectType<Promise<McpTestResponse<JSONRPCResponse>>>(client.initialize())
expectType<Promise<McpTestResponse<JSONRPCResponse>>>(client.listTools())
expectType<Promise<McpTestResponse<JSONRPCResponse>>>(
